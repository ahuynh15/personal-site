  ...
  return (
    <>
      <div className="flex items-baseline">
        ...
        <span className="relative pb-2 text-5xl before:absolute before:bottom-0 before:w-1/2 before:border-2 before:border-solid before:border-amber-700 before:content-['']">
          {name}.
        </span>
      </div>
