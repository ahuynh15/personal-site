...
const Skill = ({ index, name, subskills }) => {
  return (
    <>
      <div className="flex items-baseline text-zinc-900 transition-colors duration-500 dark:text-zinc-100">
      ...
      <div className="mt-4 ml-4 grid w-1/2 max-w-screen-lg grid-flow-row-dense grid-cols-3 gap-4 text-xl text-zinc-900 transition-colors duration-500 dark:text-zinc-100">
        {subskills.length > 0 &&
